<template>
  ...
  <p class="description">本研究では、自分の意見が強いほど、自分と意見が一致・不一致する他者に対して攻撃行動を行うかを調べています。</p>
  <p class="description">今回は、攻撃行動を測定する一つの方法として、「音のシグナル」としてどれだけの音量を聞かせるか、どういった内容のコメントを書くかを調べました。</p>
  <br/>
  <q-img 
    loading="eager"
