<template>
  ...
  <p class="description">本研究では、同時に本調査に回答している参加者とペアを組み、他者とのコミュニケーションを行う際に必要な行動を測定するゲームを行います。また、ゲームの前後であなた個人の一般的な物事への考え方についても尋ねます。</p>
  <br/>
  ...
  <p class="description text-bold text-red-9">ただし、中断した場合は報酬は支払われません。</p>
  <br/>
  <p class="title">【報酬】</p>
  ...
  <p class="description">回答は無記名で行われます。皆さまの回答は統計的に処理されますので、個人が特定されることは一切ありません。また、報酬支払い手続きのため、回答完了後に個別のID番号が発行されます。報酬の支払い完了後にIDは削除されるため、以降は調査実施機関を含め誰も回答とユーザ名を対応させることができなくなります。</p>
  <br/>
  <p class="title">【データの保管】</p>
  <p class="description">データファイルはパスワードをかけた状態で保管されます。データは、それに基づく研究結果が論文として刊行されてから最低5年間は保存されます。ただし、掲載誌の規定やその他の理由により、それ以上の保管期間が必要となる場合は、より長期の保管期間が適用されます。</p>
  <br/>
  <p class="title">【本研究に関するお問い合わせ】</p>
  <p class="description">本研究で得られた結果について・またそのほかのご質問は、Lancers上のメッセージ機能でご連絡ください。</p>
  <br/>
